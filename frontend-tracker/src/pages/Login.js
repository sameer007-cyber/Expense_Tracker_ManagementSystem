...
import { TrendingUp, Sparkles, ShieldCheck, BarChart2, Mail, Lock, ArrowRight } from "lucide-react";
      ...
      <div className="hidden md:flex w-1/2 flex-col justify-center p-14 relative overflow-hidden"
        ...
        <div className="relative">
          ...
          <h2 className="text-4xl font-extrabold leading-tight mb-3 text-white">
            ...
            <span style={{ color: "#818cf8" }}>financial hub</span>
          </h2>
          <p className="text-slate-400 text-sm mb-10 leading-relaxed">
            Sign in to access your dashboard, insights, and complete transaction history.
          </p>
        ...
        >
          ...
          <div className="bg-white rounded-2xl border p-8" style={{ borderColor: "var(--border)", boxShadow: "var(--shadow-md)" }}>
            ...
            <p className="mt-6 text-center text-sm text-slate-500">
              ...
              <Link to="/signup" className="font-bold hover:underline" style={{ color: "#5b5ef4" }}>
                Create one
              </Link>
            </p>
          </div>
